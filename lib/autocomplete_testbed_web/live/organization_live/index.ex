defmodule AutocompleteTestbedWeb.OrganizationLive.Index do
  ...
  @impl true
  def handle_info({AutocompleteTestbedWeb.OrganizationLive.FormComponent, {:saved, organization}}, socket) do
